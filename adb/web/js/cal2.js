...
//wr('<script language="JavaScript" src="/adb/js/calw.js"></script>');
wr("<script>var pw = window.opener;  <\/script>"); 
...
console.log(" writeCalWindow: " + cYear +" / " + cMonth + " / " + cDat);

//selectOptionByVal(calForm.fcal_year, cYear);
//selectOptionByVal(calForm.fcal_mon, cMonth);
selectOptionByVal(calWin.document.calForm.fcal_year, cYear);
selectOptionByVal(calWin.document.calForm.fcal_mon, cMonth);
}
