...
<!--a  id="single_image" href ="?<%=queryString%>&downloadImg=y.png" title = "<a id='full_image'  href='?<%=queryString%>&downloadImg=y.png' id='full_image' onclick = 'showFullSize(this);return false;'>Полный размер</a>">График</a-->
<a class="pirobox" rel="single" href="?<%=queryString%>&downloadImg=y.png">График</a>
<!--a  id="single_image" href ="#graphic_img">График</a>
<div style="display:none"><div id="graphic_img"><img src = "?<%=queryString%>&downloadImg=y.png"/></div></div-->
<%}%>
<%if (PageCount>1){%>
<br/>
Страницы:
