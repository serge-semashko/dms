...
<div id="menutoggle">
    ...
    <div id="fs1" title = "компактный размер шрифта" class="fontsize fs1 tiptip" onclick = "setFS('fs1');"></div>
    <div id="fs2" title = "средний размер шрифта" class="fontsize fs2 tiptip" onclick="setFS('fs2');"></div>
    <div id="fs3" title = "крупный размер шрифта" class="fontsize fs3 tiptip" onclick="setFS('fs3');"></div>
...
%>
<li <%=subMenuClass%>><a <%=(shref.startsWith("http"))?"target=\"_blank\"":""%> href="<%=shref%>"><%=sname%></a></li>
<%
}
%>
</ul>
