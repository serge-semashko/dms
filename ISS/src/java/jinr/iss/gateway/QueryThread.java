...
//       writeHttpHeaders();
                ...
                IOUtil.writeLogLn(3, "<span style='border:solid 1px blue;' > REQUEST " 
        ...
        if (log && !cfgTuner.getParameter("c").contains("showLog") ) {
            ...
            if(!excludeFromLog.contains(cfgFileName + ',')) 
                IOUtil.writeLogLn(0, "<hr><span style='border:solid 1px green; font-weight:bold; background-color:#FFFFA0;'>REQUEST " 
...
//	   stmt.close();
            ...
            IOUtil.writeLogLn(0, "<b>ERROR:</b> Connection to " + cfgTuner.getParameter("connString") 
                    + rm.getString("queryLabel") +  " FAILED! ", rm);
...
//		 e.printStackTrace(System.out);
        ...
        IOUtil.writeLogLn(2, "Connection to " + cfgTuner.getParameter("connString") 
