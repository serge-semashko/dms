...
++++++++++++++++++ Шапка документа  +++++++++++++++++++++ ??
    ...
    <table border=0 cellpadding=0 cellspacing=0 class="doc" style="min-width:900px;">
        ...
        <tr><th class="center bg_white big" 
                ...
                style="background-color:##C9EBF5;"  ??DOC_TYPE_ID=8|DOC_TYPE_ID=9|DOC_TYPE_ID=10|DOC_TYPE_ID=11|DOC_TYPE_ID=12
            colspan=2>
...
[print links]
    ...
    $SET_PARAMETERS spec_form=y;   ??WF_ID&DOC_TYPE_ID=6|DOC_TYPE_ID=8|DOC_TYPE_ID=9|DOC_TYPE_ID=10|DOC_TYPE_ID=11|DOC_TYPE_ID=15
