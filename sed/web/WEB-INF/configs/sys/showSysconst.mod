...
[report header]
    ...
    $SET_PARAMETERS RWACC=Y; ??ZZZ&AR_SYS_ADMIN=1|VU
    $SET_PARAMETERS RWACC=Y; ??USER_ID=2309|VU
...
[OK report header]
    ...
    $SET_PARAMETERS_GLOBAL #alias#=^#val_param#;   ??cop=save
...
[item]
    ...
    ><td class="nowrap">#alias#</td>
        <td>
            ...
            <div id="dw_#alias#" class="rw" style="display:none;"><textarea class="val" id="val_#alias#" name="val_#alias#" style="width:95%; height:50px;">#value#</textarea>
