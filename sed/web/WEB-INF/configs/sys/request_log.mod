...
<body>
    ...
    <a class=info href="#ServletPath#?c=sys/showSysconst">sys>></a>  ??USER_ID=2309|VU=2309
    ...
    ================================== FILTERS ==================================== ??
    $SET_PARAMETERS f_table=a_req_log; show_doc=on; f_login=Y; f_err=NF; ??!f_table
    ...
    <span class="pt" onClick="document.theForm.cop.value='clear'; 
    submitForm(true); 
    ">clear</span>
    ...
    <tr><td class=lab>Agent:</td><td><input size=20 name="f_agent" value="#f_agent#">
    <td class=lab>Dev:</td><td><input size=10 name="f_did" value="#f_did#"></td></tr>
    ...
    <tr><td class=lab>Срок:</td><td colspan=3><input type=radio name=f_today value="2"
        ...
        checked ??!f_today
        >всё
            &nbsp; дата: <input size=8 name="f_dat" value="#f_dat#">(ДД.ММ.ГГ)
            &nbsp; час: <input size=3 name="f_hour" value="#f_hour#">
        </td>
    </tr>
