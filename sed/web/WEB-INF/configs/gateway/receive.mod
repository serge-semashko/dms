...
$SET_PARAMETERS ARRAYS=Заявки,xxx;
[end]
...
[process register]
$CALL_SERVICE c=gateway/register_dogovor;    ??ObjectType=30|ObjectType=38|ObjectType=39 
