...
<td class=label>Справочник:</td><td><b>#INFO_NAME#</b>,
...
<tr><td class=label>Поля:</td><td>
$CALL_SERVICE c=admin/infos/info_list_fields; 
</td></tr>
$INCLUDE [ExtSrc] ??IS_EXTERNAL=1

<tr><td class=label>Последнее<br>обновление данных:</td><td>
...
> 
<br>Показывать: <input type=radio name=show value="changed" checked> только изменения
...
<tr><td class=label>Подключение:</td><td><b>#CONN_NAME#</b> (
MySQL ??DB_TYPE=0
Oracle ??DB_TYPE=1
MS SQL ??DB_TYPE=2
):
