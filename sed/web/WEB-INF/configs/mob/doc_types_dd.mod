...
[filter]
     ...
     <div id="f_doc_type" 
         class="filter_dd_input pt big ellipsis form-control" 
         style="display: inline-block; width:100%;" 
         onClick="showDD('f_doc_type', 'mob/doc_types_dd&selected_id=#f_doc_type_id#', 'pasteDocType');"
     >
         -- все -- ??!f_doc_type
         #f_doc_type#
     </div>
    ...
    <script type="text/javascript">
        var pasteDocType=function(id,text){
            log(2,"mob/doc_types_dd.mod.pasteDocType: " + id + " / " + text); 
...
[SQL]
    ...
    or dtp.group_id=98 ??USER_ID=2309_ZZ
