JINR/info_tender_participant_add.mod
...
childs=JINR/info_tender_participant_kontragent_data, JINR/info_tender_participant_edit_data, JINR/info_tender_participant
testURL=?c=JINR/info_tender_participant_add&irpp=30&START_REC=1
...
вывода соответсвующей таблицы (JINR/info_tender_participant_kontragent_data).<br>
