...
var commentButtonClick = function () {
    ...
    log(3, "commentButtonClick..." + cookieHelper + "; addCommentMode=" + addCommentMode);
...
var showMarkupForm = function (markup_id, x_coordinate, y_coordinate, page_id) {
    ...
    log(3, "showMarkupForm: top=" + y_coordinate + "; left=" + x_coordinate);
...
var getImgMetrics = function (container_id) {
    ...
    log(3, "getImgMetrics('" + container_id + "'):" + s);
    return s;
}
...
var showMarkupIcons = function (page_id, thmb) {
    log(3, "showMarkupIcons: page_id=" + page_id + "; thmb=" + thmb);
    if (thmb) {
...
var filter_author = function (author_id) {
    log(3, "markups_author: " + author_id);
...
var toggleTextMarkup = function (markup_nr) {
    ...
    log(3, "markupNr_" + markup_nr);
    log(3, "textMarkupHeigth= " + textMarkupHeigth);
