    ...
    <table border=0 class="tlist tborder" cellpadding=0 cellspacing=0>
        ...
        <tr><td colspan=#NUM_COLUMNS#>
            <table border=0 cellpadding=0 cellspacing=0>
                <tr>
                    <td><input type=radio name=f_rec_status value="" onclick="showNext(0);"
...
============ Строка таблицы =============== ??
[item]
    <tr onClick="ShowDialog(true); AjaxCall('popupCont','c=admin/infos/info_editRecord&record_id=#record_id#&info_id=#info_id#');" class="pt
