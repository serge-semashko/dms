...
public class ServiceShowInfoData extends ServiceViewInfoData {
    ...
    protected void showInfoRecords() throws Exception {
        ...
        String fields = cfgTuner.getParameter("FIELDS");  //ЭТО и ниже КРИВО - дублирует и переделывает код в start(), но править и снова тестить сейчас в лом. М.б., когда нибудь...
