...
public class CommonTools {
    ...
    public static String makeParamValue(String paramName, String paramType, Tuner cfgTuner) {
        ...
        if (paramValue.length() == 0) {
            if (paramType.equals("int") || paramType.equals("tinyint") || paramType.equals("boolean")
                    || paramType.equals("float") || paramType.equals("float0") || paramType.equals("numeric")
                    || paramType.equals("date") || paramType.equals("datetime")) {
                return "null";
            }
        }
        if (paramType.equals("int") || paramType.equals("tinyint") ) {
            return paramValue;
        } else if (paramType.equals("float") || paramType.equals("float0") || paramType.equals("numeric")) {
            return paramValue;
