...
// (результат выполнения запросов в секции [preSQLs] .cfg - файла)
        IOUtil.writeLogLn(3, "+++ ServiceViewDoc.makeSelectSQL()", rm); 
...
// конструируем SQL для выборки значений полей документа
                ...
                for (int i = 0; i < numFields; i++) {
                    ...
                    IOUtil.writeLogLn(7, "..." + i + ": " + fields[i] + "/" + form_fields_types[i] + " / " + sql, rm);
                ...
                IOUtil.writeLogLn(2, "+++ ServiceViewDoc.Get doc data record SQL: " + sql.replaceAll(", ", "<br>, "), rm);       
    }
