...
//  return true;
    ...
    public void getVUser(String user_id, Tuner cfgTuner, ResourceManager rm) {
        if (cfgTuner.enabledOption("q_vu_id")) {
            IOUtil.writeLog("======= getVUser() ======= user_id=" + user_id + "=>" + cfgTuner.getParameter("q_vu_id"), rm);
            String a = ",2309,413,2584,8329,4790,4241,8389,3311,97,4206,3663,";
//	2309-Куняев 413-Белякова 2584-Печникова 8329-Чихалина 4790-Яковлев 4241-Устенко 8389-Пляшкевич 3311-Приходько 97-Александров 4206-Тяпкина, 3663 - Семашко
