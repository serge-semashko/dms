	...
	public void sendMails()
	{
		...
		{ 
		  ...
		  props.put( "mail.smtp.host", rm.getString("mailServer", true) );
			if (debugMode) System.out.println("===> mailServer: '" + rm.getString("mailServer", false) + "'");
		  ...
		  props.put( "mail.smtp.user", rm.getString("mailUser", true) );
			if (debugMode) System.out.println("===> mailUser:" + rm.getString("mailUser", false));
...
//		  Session session = Session.getDefaultInstance( props, null );
		  ...
		  /*============== ADDRS =================*/
			if (debugMode) System.out.println("===> mailFrom:" + rm.getString("mailFrom", false));
